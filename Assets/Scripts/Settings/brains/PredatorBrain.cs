...
{
    public class PredatorBrain : BrainBase
    {
        PredatorBrain()
        {
            matrix[2, 14] = 0.7;
            matrix[3, 14] = -5.0; matrix[3, 16] = 0.7; matrix[3, 17] = 0.1; matrix[3, 18] = 0.4; matrix[3, 19] = -0.4; matrix[3, 20] = -0.5; matrix[3, 21] = 0.5;
            matrix[4, 14] = -5.0; matrix[4, 16] = 0.7; matrix[4, 18] = -0.1; matrix[4, 19] = 0.1; matrix[4, 20] = 0.5; matrix[4, 21] = -0.5;
            ...
            matrix[7, 17] = -5.0; matrix[7, 18] = 0.3; matrix[7, 19] = -0.3; matrix[7, 20] = -4.0; matrix[7, 21] = 0.4;
